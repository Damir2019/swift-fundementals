...
// just like array[index] -> doctionary[key]
...
print(airport.isEmpty)
// output false

// add values
airport["RUS"] = "Russia"
// added an other value

//change values
airport["RUS"] = "New Russia"

print(airport)

//print(airport["DUB"]) // return an optional value

//optional value check
// need to check the value to not get nil exception
if let airportName = airport["DUB"] {
    print(airportName)
}

airport["APL"] = "apple port"

print(airport)

// to delete a key and value we can change its value to nil
//airport["APL"] = nil

//print(airport)

// also can use the removeValue

airport.removeValue(forKey: "APL")
...
// to iterate over an dictionary in a specific way we can use sorted()
